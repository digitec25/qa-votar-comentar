...
CASOS = {
    ...
    "TC11": ("Comentario se muestra en la tabla", "CA4"),
    "TC12": ("No permite doble voto (defecto)", "CA1"),
    "TC13": ("Comentario no ejecuta XSS (seguridad)", "CA3"),
    "TC14": ("Comentario solo espacios", "CA3"),
}
